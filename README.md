...
The data from these websites are collected and stored in the [prices_track.csv](../price_track/master/price_track.csv) file and this data is sent to the webapp for data visualization.
